...
const list = {
  ...
  "castingToChinese": {
    ...
    useful: "6.0",
    params: "?directive=true&focus=false&tts=false&hideProg=false&hideCountdown=false&roomaji=true&progHeight=10px&fontSize=20px&fontFamily=SmartisanHei&ping=80",
  },
};
