let keigenns = {
  ...
  "a7a": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //オブレーション 82级新技能
  ...
  "a7b": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //ハート・オブ・コランダム 82级新技能
  "a7c": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //クラリティー・オブ・コランダム 82级新技能
  ...
  "": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //水幕帘
  ...
  "a2f": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //エウクラシア・ディアグノシス 贤技单盾
  "a30": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //エウクラシア・ディアグノシス[強] 贤技单盾暴击
  "a31": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //エウクラシア・プログノシス 贤技群盾
  "a3a": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //ケーラコレ 罩子
  "a3b": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //タウロコレ 绿帽
  "a3b": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //ハイマの印 血液质
  "bbb": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //ホーリズム 整体论
  "a53": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //パンハイマの印 多血质
  ...
  "3b": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤减轻
  "14b": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤减轻
  246: { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤减轻
  258: { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤减轻
  "32c": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤减轻
  ...
  "b42": { dodge: 1, physics: 1, magic: 0, darkness: 0, condition: "player" }, //物理受伤加重
  "b7c": { dodge: 1, physics: 1, magic: 0, darkness: 0, condition: "player" }, //物理受伤加重

  "3c": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤加重
  "1ee": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤加重
  292: { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤加重
  472: { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤加重
  "82b": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤加重
  "b7d": { dodge: 0, physics: 0, magic: 1, darkness: 0, condition: "player" }, //魔法受伤加重
  ...
  "b60": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //受伤加重

  //耐性降低
  "1af": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //水属性耐性低下
  "23c": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //斬属性耐性低下
  "23d": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //打属性耐性低下
  "240": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下
  "26d": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //火属性耐性低下
  "29e": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //火属性耐性低下
  "2ad": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //風属性耐性低下
  "333": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //斬属性耐性低下
  "334": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //突属性耐性低下
  "335": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //打属性耐性低下
  "37e": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //風属性耐性低下
  "382": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下
  "3a3": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //打属性耐性低下
  "401": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //水属性耐性低下［強］
  "402": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下［強］
  "41c": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //風属性耐性低下［強］
  "41d": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //土属性耐性低下［強］
  "471": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //火属性耐性低下[強]
  "485": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //水属性耐性低下［強］
  "4e7": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //火属性耐性低下[強]
  "4ec": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下［強］
  "4f8": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //斬属性耐性低下［強］
  "59b": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //突属性耐性低下[強]
  "69d": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //斬属性耐性低下
  "69e": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //突属性耐性低下
  "6a6": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //氷属性耐性低下
  "6f0": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //打属性耐性低下
  "7b5": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下［強］
  "82e": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //水属性耐性低下［強］
  "82f": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下［強］
  "830": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //風属性耐性低下［強］
  "831": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //土属性耐性低下［強］
  "832": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //火属性耐性低下[強]
  "860": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //水属性耐性低下［強］
  "861": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下［強］
  "8c8": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //打属性耐性低下
  "8e6": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //光属性耐性低下
  "943": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //雷属性耐性低下
  "9a1": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //氷属性耐性低下［強］
  "9cc": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //斬属性耐性低下
  "16": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, // 最大ＨＰダウン
  "1c8": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //最大ＨＰダウン
  "441": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //最大ＨＰダウン
  "567": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //最大ＨＰダウン
  "9d9": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //最大ＨＰダウン
  "b9b": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //最大ＨＰダウン
  "615": { dodge: 1, physics: 1, magic: 1, darkness: 1, condition: "player" }, //最大ＨＰ低下[強]
};
export { keigenns };
