...
let Name2Dictionaries = {
  ...
  深宫风巨魔: "视觉感知 没有威胁",
  深宫巨钳虾: "视觉感知 [吸引～顺劈～螺旋尾]的循环，有强化防御会好打很多",
  ...
  地宫死亡凝视:
    " 使用魔陶器梦魔化在低层可以造成巨量伤害，这是因为易伤的潜在价值比大部分低级技能都要高。如果你的职业可以风筝BOSS，那你可以绕着场地边缘跑来躲掉的爆裂尾。",
  大口花:
    " 使用魔陶器梦魔化来击杀BOSS和他召唤出的小怪(在它召唤时对着BOSS使用，可以通过AOE同时打到BOSS和小怪)。需要注意的是单人时可以使用生者秘药，它的伤害还是很高的。",
  宁吉兹济达: " 站在场边，引导火球-冰球-火球-冰球，走到场地中央",
  伊休妲: " 杀完小怪",
  漆黑的艾达:
    " 贴紧boss来躲环形AOE身体健康。他会释放两种身体健康，一种将要求你远离她，另一种将覆盖整个战斗区域除去她身下的一个小区域。因此请尽量靠近她来避开这个技能。除此之外，她有时会释放病入膏肓，它会立即对目标造成病弱DEBUFF，但由于她的技能释放顺序，你永远不必担心因为病弱的速度减缓而难以躲避身体健康。",
  深黑骑士: " 记得卡位，保证被点名击退后不要飞进持续地板AOE。",
  水虎龙亚夸虏: " 当boss吟唱浸泡时，把他完全拉出范围，否则他会得到加速BUFF。",
  古丹纳:
    " 远离旋风。他会在边缘施放会施加易伤的大伤害AOE呵斥，所以当他跑去边缘时，一起跟着跑过去。他的HP在18%之后就会不断吟唱黄道陨石，一发就能造成你最大血量80%的伤害。因此，把爆发留到这个时候并尽快RUSH掉它。",
  爆弹怪教母: " 把橘色小怪直接打死，把蓝色小怪推到boss边",
  死灵术士尼博斯:
    " 用魔陶器强化自身、魔陶器强化防御、生者秘药和魔陶器梦魔化，大胆的用虚空烈焰怼boss吧，他会小怪焚化殆尽。变身时间结束后，再用一个生者秘药和魔陶器基路伯化，用天罚怼爆BOSS和地上的小怪。",
  阿利坎托: " 锤人疼,没了",
  荣光魔花: " 躲开AOE，杀死小蜜蜂",
  埃尔法德: " 站在场边，引导火球-冰球-火球-冰球，跑到中间。",
  阿普切:
    " 魔陶器强化自身+魔陶器强化防御+魔陶器基路伯化套餐。你也可以不用魔陶器强化防御，那你可能就需要手动解除基路伯状态，吃个生者秘药，再用另一个魔陶器基路伯化。",
  ...
  爆弹怪教父:
    " 杀死蓝色爆弹怪(治疗爆弹怪)并把红色爆弹怪(熔岩爆弹怪)打到boss边。注意如果你被地面爆破打到或蓝色爆弹怪炸到，你会被冻住，你没有魔陶器强化防御的话基本就死了。这个BOSS的顺劈烈火怒骂超级疼",
  地宫宁基南加: "靠近感知",
  地宫南加: "靠近感知",
  以太之光:
    "以太之光（Aetheryte，エーテライト）是由水晶制成的一种魔法装置。为了安全地使用转移魔法，需要在地脉和风脉流动汇聚的节点设置以太之光。正如没有指示港口位置的灯塔船就容易遇难一样，若没有这个魔法装置，以太奔流中流动的人们就很容易迷失目的地，甚至会永远在其中彷徨。由于地脉与风脉的节点必然是拥有高浓度以太的土地。这意味着这种环境最适合人类和生物居住，也是自古以来最容易出现城市和村庄的地方。我们之所以能够看到以太之光被设立在各个聚落之中用来移动，也是出于这个原因。现在使用的以太之光多数是经萨雷安民众之手自找出来的。不过发明以太之光的人并不是他们，他们只是将远古时代的创造物重现了出来而已。有关远东之国使用的转魂塔，请参考转魂塔章节。",
};
