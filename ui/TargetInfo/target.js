...
let Name2Dictionaries = {
  ...
  伊休妲: " 杀完小怪",
  漆黑的艾达:
    " 贴紧boss来躲环形AOE身体健康。如果你正确处理每个机制，这个boss会很简单。他会释放两种身体健康，一种将要求你远离她，另一种将覆盖整个战斗区域除去她身下的一个小区域。因此请尽量靠近她来避开这个技能。这个技能除了本身的伤害之后，每个被此技能击中的敌人都会点亮一个地板上的符文，这会增加全屏AOE冥婚蜜月的伤害。除此之外，她有时会释放病入膏肓，它会立即对目标造成病弱DEBUFF，但由于她的技能释放顺序，你永远不必担心因为病弱的速度减缓而难以躲避身体健康。",
